...
<script>
        ...
        {
            alert("Password Should Be 8 Charecters "); 
            return false;

        }
       else if(c.search(/[0-9]/)==-1)
        {
            alert(" password is At least one Numeric Charecter "); 
            return false;
        }
        else if(c.search(/[a-z]/)==-1)
        {
            alert(" password is At least one Lower Case Charecter"); 
            return false;
        }else if(c.search(/[A-Z]/)==-1)
        {
            alert(" password is At least one Upper Case Charecter"); 
            return false;
        }else if(c.search(/[!\@\#\$\%\^\&\*\-\+\>\<\?]/)==-1)
        {
            alert(" password is At least one Special Character "); 
            return false;
        }
        else{
            true;
    ...
    <div class="registerform">
        ...
        <form name="myform" onsubmit="return data()" action="" method="POST" >
            <input type="text" id="n1" name="FullName" required placeholder="Full Name">
            <input type="tel"  name="MobileNo" id="n2" pattern="[1-9]{1}[0-9]{9}" maxlength="10" required placeholder="Mobile NO"><br>
            <input type="email" name="Email" required placeholder="Email">
            <input type="date" name="DOB" required placeholder="Date Of Birth"><br>
            <input type="password" id="n3" name="Password" required placeholder="Password">
